...
class kmeans
{
	...
	{
		BufferedReader csv = new BufferedReader(new FileReader(new File("/home/saqib/eclipse-workspace/Kmeans/src/input.csv")));
		...
		System.out.println(r.attr1 +" "+r.attr2); System.out.println("------2th cluster--------"); for(record r:c3)
